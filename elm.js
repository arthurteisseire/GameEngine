...
var $author$project$EntityTable$EntityId = $elm$core$Basics$identity;
var $author$project$EntityTable$EntitySet = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$EntityTable$addEntity = function (_v0) {
	var nextId = _v0.a;
	var entities = _v0.b;
	return _Utils_Tuple2(
		A2(
			$author$project$EntityTable$EntitySet,
			nextId + 1,
			A2($elm$core$List$cons, nextId, entities)),
		nextId);
};
var $author$project$EntityTable$addNEntities = F2(
	function (n, entitySet) {
		var func = F3(
			function (currentN, currentEntitySet, currentEntityIds) {
				func:
				while (true) {
					if (!currentN) {
						return _Utils_Tuple2(currentEntitySet, currentEntityIds);
					} else {
						var _v1 = $author$project$EntityTable$addEntity(currentEntitySet);
						var newSet = _v1.a;
						var entityId = _v1.b;
						var $temp$currentN = currentN - 1,
							$temp$currentEntitySet = newSet,
							$temp$currentEntityIds = A2($elm$core$List$cons, entityId, currentEntityIds);
						currentN = $temp$currentN;
						currentEntitySet = $temp$currentEntitySet;
						currentEntityIds = $temp$currentEntityIds;
						continue func;
					}
				}
			});
		return A3(func, n, entitySet, _List_Nil);
	});
var $author$project$Event$Clicked = {$: 5};
...
var $author$project$EntityTable$emptyTable = $elm$core$Dict$empty;
var $author$project$ComponentAI$identity = {};
...
var $author$project$Level1$insertComponentForEntities = F3(
	function (entities, component, table) {
		return A3(
			$elm$core$List$foldl,
			F2(
				function (entity, accTable) {
					return A3($author$project$EntityTable$insertComponent, entity, component, accTable);
				}),
			table,
			entities);
	});
...
var $author$project$Level1$init = function () {
	...
	var entities1 = _v0.a;
	var playerId = _v0.b;
	var _v1 = $author$project$EntityTable$addEntity(entities1);
	var entities2 = _v1.a;
	var terrain = _v1.b;
	var _v2 = A2($author$project$EntityTable$addNEntities, 20, entities2);
	var entities3 = _v2.a;
	var enemies = _v2.b;
	return {
		bf: A3($author$project$Level1$insertComponentForEntities, enemies, $author$project$ComponentAI$identity, $author$project$EntityTable$emptyTable),
		bg: A3(
			$author$project$Level1$insertComponentForEntities,
			enemies,
			$author$project$ComponentAnimation$identity,
			A3($author$project$EntityTable$insertComponent, playerId, $author$project$ComponentAnimation$identity, $author$project$EntityTable$emptyTable)),
		bi: A3(
			$author$project$Level1$insertComponentForEntities,
			enemies,
				...
				F2(
					function (_v3, table) {
						...
						return A3(
							$author$project$EntityTable$insertComponent,
							entityId,
							$author$project$ComponentPosition$init(pos),
							table);
					}),
				posTable,
				A2(
		...
		b7: A3(
			...
			A3($author$project$EntityTable$insertComponent, playerId, $author$project$ComponentVelocity$identity, $author$project$EntityTable$emptyTable)),
		a8: A3(
			$author$project$EntityTable$insertComponent,
			terrain,
			$author$project$ComponentVisual$terrain,
					...
					F2(
						function (entityId, table) {
							return A3(
								$author$project$EntityTable$insertComponent,
								entityId,
								$author$project$ComponentVisual$circle('orange'),
								table);
						}),
					visualTable,
					enemies);
			}(
				A3($author$project$EntityTable$insertComponent, playerId, $author$project$ComponentVisual$defaultRect, $author$project$EntityTable$emptyTable)))
	};
}();
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Level1$init, $elm$core$Platform$Cmd$none);
};
var $author$project$Event$Tick = function (a) {
	return {$: 0, a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $author$project$Event$KeyBoardInput = function (a) {
	return {$: 3, a: a};
};
var $author$project$Event$NextFrame = {$: 2};
var $author$project$Event$TogglePause = {$: 1};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$KeyboardInput$ArrowDown = 3;
var $author$project$KeyboardInput$ArrowLeft = 0;
var $author$project$KeyboardInput$ArrowRight = 1;
var $author$project$KeyboardInput$ArrowUp = 2;
var $author$project$KeyboardInput$KeyN = 5;
var $author$project$KeyboardInput$Other = 6;
var $author$project$KeyboardInput$Space = 4;
...
var $author$project$Main$keyDecoderToMsgDecoder = A2(
	$elm$json$Json$Decode$map,
	function (key) {
		switch (key) {
			case 4:
				return $author$project$Event$TogglePause;
			case 5:
				return $author$project$Event$NextFrame;
			default:
				return $author$project$Event$KeyBoardInput(key);
		}
	},
	$author$project$KeyboardInput$keyDecoder);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				function (millis) {
					return $author$project$Event$Tick(millis / 1000);
				}),
				$elm$browser$Browser$Events$onKeyDown($author$project$Main$keyDecoderToMsgDecoder)
			]));
};
var $author$project$EntityTable$foldlEntitySet = F3(
	function (func, result, _v0) {
		var list = _v0.b;
		return A3(
			$elm$core$List$foldl,
			F2(
				function (entityId, acc) {
					return A2(func, entityId, acc);
				}),
			result,
			list);
	});
var $author$project$Main$applySystem = F3(
	function (updateEntity, entitySet, world) {
		return A3($author$project$EntityTable$foldlEntitySet, updateEntity, world, entitySet);
	});
...
var $author$project$EntityTable$getComponent = F2(
	function (_v0, _v1) {
		var id = _v0;
		var dict = _v1;
...
var $author$project$Main$applyTickSystems = F3(
	function (dt, entitySet, world) {
		return A3(
			...
			$author$project$SystemAnimation$updateEntity(dt),
			entitySet,
			world);
	});
...
var $author$project$EntityTable$filterEntities = F2(
	function (isGood, _v0) {
		var lastId = _v0.a;
		var list = _v0.b;
		return A2(
...
var $author$project$EntityTable$filterTable = F2(
	function (isGood, _v0) {
		var dict = _v0;
		return A2(
			...
			F2(
				function (id, a) {
					return A2(isGood, id, a);
				}),
			dict);
	});
var $author$project$EntityTable$hasValueInTableIf = F3(
	function (predicate, a, table) {
		return !_Utils_eq(
			A2(
				$author$project$EntityTable$filterTable,
				F2(
					function (_v0, value) {
						return A2(predicate, a, value);
					}),
				table),
			$author$project$EntityTable$emptyTable);
	});
...
var $author$project$EntityTable$mapTable = F2(
	function (func, _v0) {
		var dict = _v0;
		return A2(
			$elm$core$Dict$map,
	...
	function (entitySet, world) {
		...
		while (true) {
			var _v0 = A3(
				$author$project$EntityTable$foldlEntitySet,
				F2(
					function (entityId, _v1) {
						var currentEntitiesWhoDidntMoved = _v1.a;
						var currentWorld = _v1.b;
						var _v2 = A2($author$project$SystemCollision$updateEntity, entityId, currentWorld);
						var thisEntityMoved = _v2.a;
						var newCurrentWorld = _v2.b;
						var newEntitiesWhoDidntMoved = thisEntityMoved ? A2(
							$author$project$EntityTable$filterEntities,
							function (id) {
								return !_Utils_eq(entityId, id);
							},
							currentEntitiesWhoDidntMoved) : currentEntitiesWhoDidntMoved;
						return _Utils_Tuple2(newEntitiesWhoDidntMoved, newCurrentWorld);
					}),
				_Utils_Tuple2(entitySet, world),
				entitySet);
			var entitiesWhoDidntMoved = _v0.a;
			var newWorld = _v0.b;
			if (!_Utils_eq(entitiesWhoDidntMoved, entitySet)) {
				var $temp$entitySet = entitiesWhoDidntMoved,
					$temp$world = newWorld;
				entitySet = $temp$entitySet;
				world = $temp$world;
				continue updateEntities;
			} else {
				return newWorld;
			}
		}
	...
	function (entityId, _v0) {
		...
		return A2(
			...
			A2(
				...
				$elm$core$Basics$neq(entityId),
				list));
	});
var $author$project$EntityTable$removeEntityIf = F3(
	function (isBad, entityId, entitySet) {
		return isBad ? A2($author$project$EntityTable$removeEntity, entityId, entitySet) : entitySet;
	});
var $author$project$SystemDie$updateEntity = F2(
	function (entityId, world) {
		return _Utils_update(
			world,
			{
...
var $author$project$SystemTriggerAttackAnimation$triggerAnimation = F3(
	function (damageTable, entityId, _v0) {
		...
		var allAnimations = A3(
			...
			damageTable);
		var anim = function () {
			var _v1 = $elm$core$List$head(allAnimations);
			if (!_v1.$) {
				var first = _v1.a;
				return first;
			} else {
...
var $author$project$ComponentPosition$identity = $author$project$ComponentPosition$init($author$project$Vector2$identity);
...
var $author$project$EntityTable$valuesTable = function (_v0) {
	var dict = _v0;
...
var $author$project$SystemAccelerationAI$updateAIVelocity = F3(
	function (inputTable, _v0, _v1) {
		...
		var playerPos = A2(
			$elm$core$Maybe$withDefault,
			$author$project$ComponentPosition$identity,
			$elm$core$List$head(
				A2(
					$elm$core$List$map,
					function ($) {
...
var $author$project$Event$HideDebug = {$: 7};
var $elm$html$Html$button = _VirtualDom_node('button');
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$EntityTable$entityIdToString = function (_v0) {
	var id = _v0;
...
var $author$project$ComponentAI$toString = function (_v0) {
	return 'AI()';
};
...
var $author$project$ComponentAnimation$toString = function (maybeAnimation) {
	...
	return 'ComponentAnimation(' + (content + ')');
};
...
var $author$project$ComponentDamage$toString = function (damage) {
	return 'ComponentDamage(' + (A3(
		$elm$core$List$foldl,
		F2(
...
var $author$project$KeyboardInput$toString = function (key) {
	switch (key) {
		case 0:
			return 'ArrowLeft';
		case 1:
...
var $author$project$SystemDisplayDebug$displayDebug = F2(
	function (world, entityId) {
		var hideButton = A2(
			$elm$html$Html$button,
			_List_fromArray(
				[
					$elm$svg$Svg$Events$onClick($author$project$Event$HideDebug),
					$elm$svg$Svg$Attributes$style('background-color: #b3b3b3; border-color: #cccccc;')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Hide')
				]));
		var componentToHtml = F2(
			function (table, toStr) {
		...
		var componentsDebug = _List_fromArray(
			[
				$elm$html$Html$text(
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('DisplayDebug'),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('ComponentsDebug'),
							A2($elm$html$Html$Attributes$style, 'height', '100%'),
...
var $author$project$SystemDisplayDebug$display = F2(
	function (world, maybeEntityId) {
		if (!maybeEntityId.$) {
			var entityId = maybeEntityId.a;
			return A2($author$project$SystemDisplayDebug$displayDebug, world, entityId);
		} else {
			return $elm$html$Html$text('');
		}
	});
var $author$project$EntityTable$mapEntitySet = F2(
	function (func, entitySet) {
		return A3(
			$author$project$EntityTable$foldlEntitySet,
			F2(
				function (entityId, acc) {
...
var $author$project$SystemDraw$toSvg = F2(
	function (entityId, visual) {
		return A2(
			$elm$svg$Svg$map,
			function (visualMsg) {
...
var $author$project$SystemDraw$visualToSvg = F2(
	function (visualTable, entitySet) {
		return $author$project$EntityTable$valuesTable(
			A3(
				$author$project$EntityTable$mapEntities,
				F2(
					function (entityId, visual) {
						return A2($author$project$SystemDraw$toSvg, entityId, visual);
					}),
				visualTable,
				entitySet));
	});
var $author$project$Level1$visual = function (world) {
	var terrains = A2(
		$author$project$EntityTable$mapEntitySet,
		function (entityId) {
			return A2(
				$elm$core$Maybe$withDefault,
				$elm$html$Html$text(''),
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('Level1'),
	...
	return {
		bj: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('MainWindow'),
						A2($elm$html$Html$Attributes$style, 'width', '100%'),
						A2($elm$html$Html$Attributes$style, 'height', '955px'),
						A2($elm$html$Html$Attributes$style, 'background-color', '#b3b3b3')
					]),
				_List_fromArray(
					[
